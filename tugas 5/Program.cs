...
namespace Adventure_Game
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            player.Nama = Console.ReadLine();
            Console.WriteLine("Hi "+player.Nama+", ready to begin the game?[y/n]");
            string bReady = Console.ReadLine();
            if(bReady == "y")
            {
                Console.WriteLine(player.Nama+" is entering the world...");
                Enemy enemy1 = new Enemy("Butter Fly");
                Console.WriteLine(player.Nama+" is encountring "+enemy1.Nama);
                Console.WriteLine(enemy1.Nama+" attacking you...");
                ...
                while (!player.IsDead && !enemy1.IsDead) // bisa menggunakan &&
                {
                    ...
                    switch(playerAction){
                        case "1" :
                        Console.WriteLine(player.Nama+" is doing single Attack");
                        ...
                        break;
                        case "4" :
                        Console.WriteLine(player.Nama+" is running away...");
                        break;
                    }
                    continue;
                }
                
                Console.WriteLine(player.Nama+" get"+player.Experienc+" experience point.");
            }
            else
            {
    ...
    class Novice
    {
        ...
        public void GetHit(int hitValue){
            Console.WriteLine(Nama+" get hit by "+hitValue);
    ...
    class Enemy
    {
        ...
        public void Die(){
            Console.WriteLine(Nama +" is dead");
            IsDead = true;
        }
    }
}
